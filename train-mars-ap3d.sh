# run in cccloud
CUDA_VISIBLE_DEVICES=0 python train.py --root /mnt/File/shamgholi/datasets/ -d mars --arch ap3dres50 --gpu 0 --save_dir ./logs/row63 --train_batch 32 --test_batch 32 --lr 0.00003 --eval_step 10 --distance cosine --pretrain ./logs/row57/best_model.pth.tar #--weight_decay 0.001
